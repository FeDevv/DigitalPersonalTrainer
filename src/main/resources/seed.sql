...
-- SCRIPT: seed.sql
-- DESCRIZIONE: Popolamento del database con dataset per ambiente di test/demo.
-- DATASET: 1 Proprietario, 3 Segreteria, 5 PT, 8 Clienti.
-- =============================================================================

USE digital_personal_trainer;

-- -----------------------------------------------------------------------------
-- 1. POPOLAMENTO ANAGRAFICHE (UTENTI E RUOLI)
-- -----------------------------------------------------------------------------

-- [PROPRIETARIO]: Amministratore unico del sistema
INSERT INTO PROPRIETARIO (Nome, Cognome, Email, Password) VALUES
('Roberto', 'Ferrari', 'admin@digitalpt.it', 'password123');

-- [ADDETTO_SEGRETERIA]: Personale per gestione anagrafica e assegnazioni
...
-- [PT]: Personal Trainer con capacità di redazione schede
...
-- [CLIENTE]: Atleti (Note: Stato iniziale attivo per superare i vincoli dei Trigger)
...
-- -----------------------------------------------------------------------------
-- 2. CATALOGO ATTREZZATURE ED ESERCIZI (PROPRIETARIO)
-- -----------------------------------------------------------------------------

-- [MACCHINARIO]: Definizione parco macchine
...
-- [ESERCIZIO]: Definizione movimenti (Rigido legame con Macchinario o Corpo Libero)
...
-- -----------------------------------------------------------------------------
-- 3. WORKFLOW DI ASSEGNAZIONE (SEGRETERIA)
-- -----------------------------------------------------------------------------

-- [ASSEGNA]: Stabilisce l'autorizzazione PT-Cliente richiesta dai Trigger di SCHEDA
...
-- -----------------------------------------------------------------------------
-- 4. PIANI DI ALLENAMENTO (PT)
-- -----------------------------------------------------------------------------

-- [SCHEDA]: Routine personalizzate (Massimo 1 attiva per cliente)
...
-- -----------------------------------------------------------------------------
-- 6. STORICIZZAZIONE E STATI FINALI
-- -----------------------------------------------------------------------------

-- Retrodatazione delle sessioni concluse per la reportistica
...
-- Simulazione di utenti disattivati (Test della Business Logic di protezione)
